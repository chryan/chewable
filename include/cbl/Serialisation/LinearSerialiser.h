...
/**
 * @file LinearSerialiser.h
 * @brief Linear serialiser class.
 */

#ifndef __CBL_LINEARSERIALISER_H_
#define __CBL_LINEARSERIALISER_H_
...
namespace cbl
{
	class CBL_API LinearSerialiser :
		public Serialiser
	{
	private:
	...
	protected:
		...
		virtual StreamPtr OnType( StreamPtr s, const Type* type ) = 0;
		//! Virtual method to write data of a type.
		virtual StreamPtr OnValue( StreamPtr s, const Type* type, const void* obj, const FieldAttr* attr ) = 0;

	/***** Private Methods *****/
	private:
		//! Linear serialisation method.
		virtual StreamPtr DoSerialise( StreamPtr s, const Type* type, const void* obj, const FieldAttr* attr, bool outputType );
	};
}

#endif // __CBL_LINEARSERIALISER_H_
